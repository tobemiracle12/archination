              ...
              {properties.map((item, index) => (
                <div key={index} className="flex overflow-hidden flex-col">
                  <div className="flex relative w-full ">
                    <div className="flex absolute z-10 top-4 left-3">
                    ...
                    {item.pictures.length > 0 && (
                      <div className="rounded-[10px] overflow-hidden w-full">
                        <Image
                          ...
                          sizes="100vw"
                          className="h-[200px] xl:h-[320px] w-full object-cover"
                          width={0}
                          height={0}
                          alt="real"
                        />
                    ...
                    <div className="flex text-center items-center absolute right-3 top-4">
